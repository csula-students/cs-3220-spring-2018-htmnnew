  ...
  */
	getCost() {
		...
		if (this.quantity == 0) {
			...
			const newcost = this.baseCost * Math.pow(1 + _constants2.default.growthRatio, this.quantity);
    ...
    switch (action.type) {
        ...
        case _constants2.default.actions.CHECK_STORY:
            ...
            state.story.forEach(function (element) {
                const temp = new _story2.default(element);
...
exports.default = function (store) {
	return class GeneratorComponent extends window.HTMLElement {
		...
		handleStateChange(newState) {
			const temp = new _generator2.default(newState.generators[this.num]);
...
exports.default = function (store) {
	return class StoryBookComponent extends window.HTMLElement {
		...
		handleStateChange(newState) {
			const temp = new _story2.default(newState.story[this.num]);
